...
export class Slideshow extends Component {
  ...
  connectedCallback() {
    ...
    this.prevButton = this.querySelector('[data-slideshow-prev]');
    this.nextButton = this.querySelector('[data-slideshow-next]');
    this.dotsContainer = this.querySelector('[data-slideshow-dots]');
    this.currentIndex = parseInt(this.getAttribute('initial-slide')) || 0;
